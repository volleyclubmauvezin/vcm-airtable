...
TRANSACTIONS = [
    ...
    t("2026-04-13", "Dépense", "Événement", 91.00, "Chèque",
      commentaire="Inscription + repas — Championnat départemental à Mirande", sous_categorie="Championnat départemental Mirande"),
    ...
    t("2026-07-02", "Dépense", "Événement", 62.65, "Chèque",
      commentaire="Achat saucisses et merguez — Barbecue de fin juin 2026", sous_categorie="Barbecue fin juin 2026"),
